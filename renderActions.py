bl_info = {
	"name": "Render Defined Actions And Render Layers",
	"description": "Render defined actions and render layers",
	"author": "Denis Cera",
	"version": (1, 0),
	"blender": (2, 69, 0),
	"location": "Toolshelf",
...
bpy.types.Scene.save_path = StringProperty(
	name = "Save Path",
	default = "C:/Downloads/blender GUI/scriptTest/")
	
bpy.types.Scene.camera_angles = IntProperty(
	name = "Camera Angles", 
	description = "Enter amount of render directions",
	default = 8)
...
class CreateRenderAllActionsPanel(bpy.types.Panel):
	bl_label = "Render All Fake Actions"
	bl_space_type = "VIEW_3D"
	bl_region_type = "TOOLS"
	bl_category = "RenderAllActions"
	...
	def draw(self, context):
		...
		layout.separator()
		layout.operator("scene.render_allactions", text="Render All Fake Actions")
